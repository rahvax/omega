...
## Aviso
O projeto agora está no Forgejo, e aqui é apenas um `Push Mirror` do Forgejo para o Github. Meu Forgejo é um projeto privado do meu grupo, então ainda não tenho intenção de colocar em público. Mas todas as issues podem serem enviadas, ou PRs, que irei conferir.
